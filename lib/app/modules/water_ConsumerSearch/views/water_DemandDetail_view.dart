                                ...
                                rows: [
                                  DataRow(
                                    cells: [
                                      ...
                                      DataCell(buildDecoratedContainer(Text(nullToNA(controller.searchedConsumerDataById[0]['meterDetails']['final_meter_reading'].toString())))),
