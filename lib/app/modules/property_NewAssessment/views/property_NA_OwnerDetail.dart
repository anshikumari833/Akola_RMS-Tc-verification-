  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Form(
          key: controller.ownerDetailsFormKey,
            child: Column(
              children: [
                Column(
                  children: [
                                    ...
                                    builder: (BuildContext context) {
                                      ...
                                      return StatefulBuilder(
                                        builder: (BuildContext context, StateSetter setState)
                                        {
                                              ...
                                              child:  Column(
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Row(
                                                      children: [
                                                          Flexible(child: Text("Note : Please make sure that the device has the Marathi keyboard installed.For marathi please use marathi keyboard. ", style: GoogleFonts.literata(
                                          ...
                                          RawKeyboardListener(
                                            focusNode: controller.marathiFocusNode,
                                            onKey: (RawKeyEvent event) {
                                              if (event is RawKeyDownEvent) {
                                                String marathiChar =  controller.convertToMarathi(event.logicalKey.keyLabel);
                                                if (marathiChar.isNotEmpty) {
                                                  // Append the Marathi character to the text field
                                                  controller.ownerMarathiNameController[currentIndex].text += marathiChar;
                                                }
                                              }
                                            },
                                            child: TextFormField(
                                          ...
                                          // Obx(() => Padding(
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: DropdownButtonFormField2(
                                                      ...
                                                      onChanged: (value) {
                                                        controller.gender.value[currentIndex] = value.toString();
                                                      },
                                                    ),
                                                  ),
                                                  //DOB
                                                  ...
                                                  RawKeyboardListener(
                                                    focusNode: controller.guardianMarathiFocusNode,
                                                    onKey: (RawKeyEvent event) {
                                                      if (event is RawKeyDownEvent) {
                                                        String marathiChar = controller.convertToMarathi(event.logicalKey.keyLabel);
                                                        if (marathiChar.isNotEmpty) {
                                                          // Append the Marathi character to the text field
                                                          controller.guardianMarathiNameController[currentIndex].text += marathiChar;
                                                        }
                                                      }
                                                    },
                                                    child: TextFormField(
                                                      ...
                                                      // ],
                                                      decoration: InputDecoration(
                                                        labelText: 'Guardian Name (Marathi)',
                                                      ),
                                                      validator: (value) {
                                                        if (value!.isEmpty) {
                                                          return 'Please enter';
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: DropdownButtonFormField2(
                                                      ...
                                                      onChanged: (value) {
                                                        controller.relation.value[currentIndex] = value.toString();
                                                      },
                                                    ),
                                                  ),
                                                  //MOBILE NO
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: DropdownButtonFormField2(
                                                      ...
                                                      onChanged: (value) {
                                                        controller.isArmedForce.value[currentIndex] = value.toString();
                                                      },
                                                    ),
                                                  ),
                                                  // IS SPECIALLY ABLED
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: DropdownButtonFormField2(
                                                      ...
                                                      onChanged: (value) {
                                                        controller.isSpeciallyAbled.value[currentIndex] = value.toString();
                                                      },
                                                    ),
                                                  ),
                                                  //  BUTTONS
                                                  ...
                                                  ElevatedButton(
                                                    ...
                                                    onPressed: () {
                                                      ...
                                                      ownerData = {
                                                        ...
                                                        "Guardian Marathi Name" : controller.guardianMarathiNameController[currentIndex].text.toString(),
                                                        "Gender" : controller.gender.value[currentIndex],
                                                        ...
                                                        "Relation" : controller.relation.value[currentIndex],
                                                        "Mobile No" : controller.mobileNoController[currentIndex].text.toString(),
                                                        "Aadhar No" : controller.aadharNoController[currentIndex].text.toString(),
                                                        "Pan No" : controller.panNoController[currentIndex].text.toString(),
                                                        "Email" : controller.emailController[currentIndex].text.toString(),
                                                        "Is Armed Force" : controller.isArmedForce.value[currentIndex],
                                                        "Is Specially Abled" : controller.isSpeciallyAbled.value[currentIndex],
                                                      };
                                                      setState(() {
                    ...
                    Obx(() {
                      return Padding(
                        ...
                        child: ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemCount: controller.ownerDataList.length,
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  buildLabeledText('Owner Name', ownerData['Owner Name']),
                                  buildLabeledText('Owner Marathi Name', ownerData['Owner Marathi Name']),
                                  buildLabeledText('Gender', ownerData['Gender'].toString()),
                                  buildLabeledText('DOB', ownerData['DOB']),
                                  buildLabeledText('Guardian Name', ownerData['Guardian Name']),
                                  buildLabeledText('Guardian Marathi Name', ownerData['Guardian Marathi Name']),
                                  buildLabeledText('Relation', ownerData['Relation'].toString()),
                                  buildLabeledText('Mobile No',ownerData['Mobile No']),
                                  buildLabeledText('Aadhar No',ownerData['Aadhar No']),
                                  buildLabeledText('Pan No', ownerData['Pan No']),
                                  buildLabeledText('Email', ownerData['Email']),
                                  buildLabeledText('Is Armed Force', ownerData['Is Armed Force'].toString()),
                                  buildLabeledText('Is Specially Abled', ownerData['Is Specially Abled'].toString()),
                                  // Center(
                                  //     child: Row(
                                  //       children: [
                                  //         IconButton(
                                  ...
                                  //                                     'isArmedForce': controller.isArmedForce[currentIndex],
                                  //                                     'isSpeciallyAbled': controller.isSpeciallyAbled[currentIndex]
                                  //                                   };
                                  //
                ...
                Column(
                  children: [
                    ElevatedButton(
                      onPressed: () {
                        if (controller.ownersController.isEmpty) {
...
//               Padding(
//                 padding: const EdgeInsets.all(8.0),
//                 child: Text('Owner Name: ${ownerData['Owner Name']}'),
//               ),
//               Padding(
//                 padding: const EdgeInsets.all(8.0),
