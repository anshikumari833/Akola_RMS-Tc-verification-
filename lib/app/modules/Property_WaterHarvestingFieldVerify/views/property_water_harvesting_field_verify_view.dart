import 'package:amc_rms/app/modules/Property_WaterHarvestingFieldVerify/views/property_water_harvesting_form_view.dart';
...
class PropertyWaterHarvestingFieldVerifyView
    extends GetView<PropertyWaterHarvestingFieldVerifyController> {
  const PropertyWaterHarvestingFieldVerifyView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          child: Text(" Harvesting Verification",style:GoogleFonts.publicSans(
            fontSize: 20,
                ...
                child: Column(
                  children: [
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {
                                   controller.waterHarvestingDetail(1, performSearch: true);
                                },
                    ...
                    Obx(() {
                      ...
                      if (controller.applicantData.isEmpty) {
                        return
                          Container(
                            height:400,
                            child: Center(
                      ...
                      return  ListView.builder(
                        ...
                        itemCount: controller.applicantData.length ,
                        itemBuilder: (BuildContext context,  index) {
                          final WaterHarvestingData data = controller.applicantData[index];
                          return GestureDetector(
                            onTap: () async {
                              // await controller.filterbyUserData(controller.applicantdata[index](data.id));
                              await controller.filterbyUserData(data.id ?? 0);
                              Get.to(PropertyWaterHarvestingFormView(),
                                  arguments: [{"applicationId": 208}],  preventDuplicates: true);
                            },
                            child: Container(
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              children: [
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: Image.asset(
                                                            "assets/images/harvesting image.png"),
                                                      ),
                                                      // SizedBox(
                                                      //   child: Column(
                                                      //     children: [
                                                ...
                                                //       children: [
                                                //         Text(
                                                //           "Applicant Name  - " + (data.applicantName?.toString() ?? ""),
                                                //           style: GoogleFonts.publicSans(
                                                //             fontSize: 10,
                                                //             fontWeight: FontWeight.w600,
                                                //             fontStyle: FontStyle.normal,
                                                ...
                                                //         ),
                                                //         Text(
                                                //           "Holding No  -"+   (data.holdingNo?.toString() ?? ""),
                                                //           style: GoogleFonts.publicSans(
                                                //             fontSize: 10,
                                                //             fontWeight: FontWeight.w600,
                                                //             fontStyle: FontStyle.normal,
                                                ...
                                                Expanded(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        _buildDetailsRow('Application No -',  capitalizeFirstLetter(data.applicationNo?.toString() ?? "")),
                                                        ...
                                                        _buildDetailsRow('Date-', capitalizeFirstLetter(data.date?.toString() ?? "")),
