...
import '../providers/water_daily_collection_report_provider.dart';
import '../views/water_DailyReport(SecondPage).dart';

class WaterDailyCollectionReportController extends GetxController {
...
// Pagination methods
  ...
  // Function to retrieve report details
  Future<void> getReportDetail(int page) async {
    ...
    reportList.clear();
    APIResponse response = await WaterDailyCollectionReportProvider().searchWaterDailyReportDetail(page, perPage,{
    ...
    isLoading.value = false;
     Get.to(WaterDailyReportMainReportView());
  }
  //***************************************************************************************************************************************
  //RECEIPT TABLE
  //^^^ method to create a table with specific columns and report details, converting it to a formatted string
  ...
  //***************************************************************************************************************************************
  //^^^ generates footer text based on provided data
  ...
  //PRINT
  //^^^  Method to initiate printing on a POS device
