...
class WaterDailyCollectionReportView extends GetView<WaterDailyCollectionReportController> {
  const WaterDailyCollectionReportView({Key? key}) : super(key: key);
  @override
              ...
              child:  Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Lottie.asset('assets/lottie/WATER_DailyReport.json'),
                    // Image.asset(
...
void _showDialog(
    BuildContext context, WaterDailyCollectionReportController controller) {
  Get.defaultDialog(
