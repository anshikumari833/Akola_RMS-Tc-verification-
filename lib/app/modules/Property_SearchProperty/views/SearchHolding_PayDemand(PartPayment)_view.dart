//PHASE - 2 (CODE OF DEMAND PAYMENT WITH PART PAYMENT)
...
class DemandPartPaymentView extends GetView<PropertyPayPropertyTaxController> {
  const DemandPartPaymentView({Key? key}) : super(key: key);
  @override
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildDetailsRow('Owner Name',controller.basicDetails['owner_name'].toString()),
                  _buildDetailsRow('Owner Name(In Marathi)',controller.basicDetails['owner_name_marathi'].toString()),
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        SizedBox(height: 8,),
                                        if(controller.demand_PaymentMethod.value == '' )
                                          Column(
                                            children: [
                                              SizedBox(height: 5,),
                                            ],
                                        ...
                                        //FOR FULL PAYMENT
                                        SizedBox(height: 8,),
                                        if(controller.demand_PaymentMethod.value == 'isFullPayment' )
                                          Column(
                                            children: [
                                              SizedBox(height: 5,),
                                              Row(
                                              ...
                                              Row(
                                                children: [
                                                  Flexible(
                                                    child: Text(
                                                      "   Total Amount to be paid is ${controller.payableAmount.toString()}",
                                                      style: GoogleFonts.publicSans(
                                                        fontWeight: FontWeight.w600,
                                                        fontSize: 15,
                                                        fontStyle: FontStyle.normal,
                                        ...
                                        //FOR ARREAR
                                        SizedBox(height: 8,),
                                        if(controller.demand_PaymentMethod.value == 'isArrearPayment' )
                                          Column(
                                            children: [
                                              SizedBox(height: 5,),
                                              Row(
                                        ...
                                        //FOR PART PAYMENT
                                        if(controller.demand_PaymentMethod.value == 'isPartPayment' )
                                          Column(
                                            children: [
                                              SizedBox(height: 5,),
                                              Row(
                                              ...
                                              Row(
                                                children: [
                                                  Flexible(
                                                    child: Text(
                                                      "   Fill the amount you want to pay.",
                                                      style: GoogleFonts.publicSans(
                                                        fontWeight: FontWeight.w600,
                                                        fontSize: 15,
                                                        fontStyle: FontStyle.normal,
                                        ...
                                        CustomDropdownFormField(
                                          ...
                                          items: [
                                            ...
                                            DropdownMenuItem(
                                              child: Text("Arrear Payment"),
                                              value: "isArrearPayment",
                                            ),
                                            DropdownMenuItem(
                                          ...
                                          onChanged: (DemandMethod) {
                                            controller.demand_PaymentMethod.value = DemandMethod.toString();
                                          },
                                        ),
                                        // 🔘 🔘 🔘 IN CASE OF PART PAYMENT
                                        if (controller.demand_PaymentMethod.value == 'isPartPayment')
                                          CustomTextField(
                                            controller: controller.partPaymentAmountController,
                                            headingText: "Part Amount", hintText: "Enter Amount ",validator: (value) {
                                        ...
                                        Visibility(
                                          visible: controller.demand_PaymentMethod.value == '',
                                          child: SizedBox(height: 30),
                                        ),
                                        // SizedBox(height:20,),
                                        //  🔴 🔴 🔴 IN CASE OF CASH PAYEMNT (full, arrear, part )
                                                                  ...
                                                                  return AlertDialog(
                                                                    ...
                                                                    actions: [
                                                                      ...
                                                                      TextButton(
                                                                        onPressed: () {
                                                                          Navigator.of(context).pop(); // Close the dialog
                                                                          controller.DemandTaxPayment(type: '');
                                                                        },
                                                                        child: Text("Confirm"),
                                                                      ),
                                                                    ],
